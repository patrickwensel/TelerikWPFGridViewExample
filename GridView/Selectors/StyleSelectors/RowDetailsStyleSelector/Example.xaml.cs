...
namespace Telerik.Windows.Examples.GridView.Selectors.StyleSelectors.RowDetailsStyleSelector
{
	...
	public partial class Example
	{
        ...
        private void Example_ThemeChanged(object sender, System.EventArgs e)
        {
            ...
            this.root.Resources.MergedDictionaries.Add(new ResourceDictionary() { Source = new Uri("/GridView;component/Selectors/StyleSelectors/RowDetailsStyleSelector/DetailsPresenterStyle.xaml", UriKind.RelativeOrAbsolute) });
        }
    }
}
