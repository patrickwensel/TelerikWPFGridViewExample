...
namespace Telerik.Windows.Examples.GridView.Selectors.StyleSelectors.GroupRowStyleSelector
{
	...
	public partial class Example
	{
        ...
        private void Example_ThemeChanged(object sender, System.EventArgs e)
        {
            ...
            this.root.Resources.MergedDictionaries.Add(new ResourceDictionary() { Source = new Uri("/GridView;component/Selectors/StyleSelectors/GroupRowStyleSelector/GroupHeaderRowStyle.xaml", UriKind.RelativeOrAbsolute) });
        }
    }
}
