...
namespace Telerik.Windows.Examples.GridView.CustomRowLayout
{
	...
	public partial class Example
	{
        ...
        private void Example_ThemeChanged(object sender, System.EventArgs e)
        {
            ...
            this.root.Resources.MergedDictionaries.Add(new ResourceDictionary() { Source = new Uri("/GridView;component/CustomRowLayout/GridViewRowStyle.xaml", UriKind.RelativeOrAbsolute) });
        }
    }
}